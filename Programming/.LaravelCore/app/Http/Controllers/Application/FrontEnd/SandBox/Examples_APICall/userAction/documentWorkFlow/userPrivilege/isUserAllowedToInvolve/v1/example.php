...
| ▪ API Key     : userAction.documentWorkFlow.userPrivilege.isUserAllowedToInvolve                                                 |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2023 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\userAction\documentWorkFlow\userPrivilege\isUserAllowedToInvolve\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     userAction.documentWorkFlow.userPrivilege.isUserAllowedToInvolve.v1_throughAPIGateway                |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       userAction.documentWorkFlow.userPrivilege.isUserAllowedToInvolve.v1_throughAPIGateway              |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/                                                                                    |
        |                     userAction.documentWorkFlow.userPrivilege.isUserAllowedToInvolve.v1_throughAPIGatewayJQuery          |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       userAction.documentWorkFlow.userPrivilege.isUserAllowedToInvolve.v1_throughAPIGatewayJQuery        |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
