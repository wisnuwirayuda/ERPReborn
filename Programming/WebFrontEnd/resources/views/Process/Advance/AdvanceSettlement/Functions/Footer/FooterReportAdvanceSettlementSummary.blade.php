    ...
    function getDataReport() {
        ...
        $('#table_summary').DataTable({
            ...
            drawCallback: function (settings) {
                $('#grandTotalExpenseIDR').text(currencyTotal(totalExpenseClaim));
                // $('#table_summary tfoot th:nth-child(3)').text(currencyTotal('0'));
                $('#grandTotalExpenseEquivalentIDR').text(currencyTotal('0'));
                $('#grandTotalCompanyIDR').text(currencyTotal(totalAmountDueCompany));
                // $('#table_summary tfoot th:nth-child(6)').text(currencyTotal('0'));
                $('#grandTotalCompanyEquivalentIDR').text(currencyTotal('0'));
                $('#grandTotalSettlementIDR').text(currencyTotal(totalAdvanceSettlement));
                // $('#table_summary tfoot th:nth-child(9)').text(currencyTotal('0'));
                $('#grandTotalSettlementEquivalentIDR').text(currencyTotal('0'));
            }
        });
    }
