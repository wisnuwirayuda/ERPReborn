    ...
    <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0 justify-content-sm-end justify-content-md-end">
      <div>
        <div class="input-group" id="debit_note_date_range_container">
          ...
          <input readonly type="text" class="form-control" style="height: 21.8px;border-radius:0;background-color:white;" id="debit_note_date_range" name="debit_note_date_range" />
        </div>
      </div>
    </div>
  </div>
